...
var mixer = mixitup('.portifolio__container', {
    selectors: {
        target: '.portifolio__content'
    },
    animation: {
        duration: 400
    }
...
const linkProtifolio = document.querySelectorAll('.portifolio__item')

function activePortifolio() {
    if(linkProtifolio) {
        linkProtifolio.forEach(l => l.classList.remove('active-portifolio'));
        this.classList.add('active-portifolio');
    }
}
linkProtifolio.forEach(l => l.addEventListener('click', activePortifolio));
